    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.tag == "Player")
        {
            ...
            if (itemCheck == "Key")
            {
                ...
                if (objectName == "S5 Key A") itemNote = TextManager.S5_ItemGet_A;
                if (objectName == "S5 Key B") itemNote = TextManager.S5_ItemGet_B;
                if (objectName == "S5 Key C") itemNote = TextManager.S5_ItemGet_C;
                if (objectName == "S5 Key D") itemNote = TextManager.S5_ItemGet_D;
                if (objectName == "S5 Key E") itemNote = TextManager.S5_ItemGet_E;
                if (objectName == "S5 Key F") itemNote = TextManager.S5_ItemGet_F;
            }
            if (itemCheck == "Main")
            {
                if (objectName == "S1 Alcohol") itemNote = TextManager.ItemGet_Alcohol;
                if (objectName == "S2 Vitamins") itemNote = TextManager.ItemGet_Vitamins;
