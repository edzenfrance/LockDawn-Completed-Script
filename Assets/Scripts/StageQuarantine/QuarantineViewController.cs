...
public class QuarantineViewController : MonoBehaviour
{
    [SerializeField] private CanvasGroup overlay;
    [SerializeField] private Transform overlayObject;
    [SerializeField] private QuarantineController quarantineController;
    ...
    void OnBackComplete()
    {
        ...
        quarantineController.QuarantineExit();
    }
}
